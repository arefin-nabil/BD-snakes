...
public class SnakeBiteList extends AppCompatActivity {
    ...
    private void hashMapdata() {
        ...
        hashMap.put("resource", "রিসোর্স - সর্প দংশনে সচেতনতা অ্যাপ");
    ...
    private class myAdapter extends RecyclerView.Adapter<SnakeBiteList.myAdapter.myViewholder> {
        ...
        private class myViewholder extends RecyclerView.ViewHolder {
            ...
            ImageView arrowImg, image;
            TextView question, answer, resource;
            ...
            public myViewholder(@NonNull View itemView) {
                ...
                resource = itemView.findViewById(R.id.author);
        ...
        public void onBindViewHolder(@NonNull SnakeBiteList.myAdapter.myViewholder holder, int position) {
            ...
            String question = (String) hashMap.get("title");
            String answer = (String) hashMap.get("detail");
            String resource = (String) hashMap.get("resource");
            String image = hashMap.get("image");


            holder.question.setText(question);
            holder.answer.setText(answer);
            holder.resource.setText(resource);
            ...
            boolean isDarkMode = (SnakeBiteList.this.getResources().getConfiguration().uiMode
